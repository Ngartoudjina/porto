...
export default function ProgrammingLanguages() {
  const languages = [
    ...
    },
    {
      ...
      color: '#0891b2',
      bgColor: '#ecfeff',
      icon: <Feather className="w-8 h-8 text-cyan-600" />,
    },
    {
      name: 'Python',
      percentage: '95%',
    ...
    },
    {
      ...
      color: '#15803d',
      bgColor: '#f0fdf4',
      icon: <Microchip className="w-8 h-8 text-green-600" />,
    },
    {
      name: 'MATLAB',
      percentage: '95%',
      color: '#0e7490',
      bgColor: '#ecfeff',
      icon: <FunctionSquare className="w-8 h-8 text-teal-600" />,
    },
  ];
      ...
      >
        <motion.div className="text-center mb-12" variants={itemVariants}>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">
            <span className="text-blue-600">Langages pour</span>
          </h1>
