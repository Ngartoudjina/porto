  ...
  const services = [
    {
      ...
      description: "Conception de systèmes innovants pour l'énergie solaire, éolienne et bioénergétique afin de promouvoir une production énergétique durable.",
    },
    {
      id: 2,
      icon: Factory,
      title: "Optimisation des processus",
      description: "Amélioration des processus industriels grâce à une modélisation avancée et des technologies écoénergétiques.",
    },
    {
      id: 3,
      icon: Thermometer,
      title: "Conception de systèmes durables",
      description: "Développement de conceptions écologiques pour les systèmes énergétiques et les applications d'ingénierie des processus.",
    },
  ];
      ...
      >
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              aria-label="Explorer toutes les expertises"
            >
              <ArrowRight className="w-4 h-4" />
              <Link href="/projets">
                <span className="text-sm font-medium">Explorer mon expertise</span>
              </Link>
            </Button>
          </motion.div>
        </motion.div>
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
            ...
            <span className="text-gray-900"> que je propose</span>
          </h2>
        </motion.div>
